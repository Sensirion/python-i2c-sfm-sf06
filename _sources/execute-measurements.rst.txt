...
1. Install the SFM-SF06 driver and all required packages as described in :ref:`Installation`.
...
4. Connect the SFM-SF06 sensor to the SEK-SensorBridge
...
.. literalinclude:: ../examples/example_usage_sensorbridge_sfm_sf06.py
    :language: python
...
1. Install the SFM-SF06 driver and all required packages as described in :ref:`Installation`.
2. Connect the SFM-SF06 sensor to the I²C port of your system (for example to the I²C port 1 of a Raspberry Pi).
...
.. literalinclude:: ../examples/example_usage_linux_sfm_sf06.py
    :language: python
